...
In Experiment 2, we more directly test the hypothesis that speakers naturally produce more informative referring expressions in more uncertain contexts (e.g. contexts where objects are occluded such as those used in Director-Matcher tasks to test theory of mind use). 
