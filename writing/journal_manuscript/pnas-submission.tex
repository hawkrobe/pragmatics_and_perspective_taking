...
Humans can accurately and intelligently reason about the mental states of other humans. Theory of mind \cite{PremackWoodruff78_ChimpanzeeToM} allows us to infer the underlying beliefs and intentions that motivate others' actions, and to use these inferences to predict future actions \cite{BakerSaxeTenenbaum09_ActionUnderstandingInversePlanning}. 
...
Theory of mind is especially critical for communication; speakers refer to the same object in widely different ways depending on the context, and listeners draw inferences---or \emph{implicatures}---from violations of rational behavior. % use specific example
