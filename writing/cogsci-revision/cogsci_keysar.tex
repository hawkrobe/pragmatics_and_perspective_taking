...
\begin{center}
\vspace{-.5cm}
\includegraphics[scale=.45]{images/mousetracking.pdf}
...
\vspace{-.5cm}
\caption{Item-wise error rates compared with label fitness ratios, for Expt.~1. Fitness ratios are scaled to the unit interval in order to visually compare to error rates. Error bars are bootstrapped 95\% confidence intervals for fitness and 95\% highest posterior density intervals for error rates.}
\vspace{-.5cm}
\label{fig:itemLevel}
\end{center}
\end{figure}
