...
\ndg{remind me (and reader) what this model comparison means?}
...
\ndg{is this expt 1 or 2 data? say ratio is scaled to unit interval in order to compare visually to error rates?}
}
\label{fig:itemLevel}
\end{center}
\end{figure}
