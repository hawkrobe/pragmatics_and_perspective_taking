...
var stimList = function() {
  ...
  var soccerBall = {
    url: 'js/stimuli/soccerBall.png', name: "soccerBall", width: 100, height: 100,
  ...
  var airplane = {
    url: 'js/stimuli/airplane.png', name: 'airplane', width: 130, height: 60,
  ...
  var stapler = {
    url: 'js/stimuli/stapler.png', name: "stapler", width: 80, height: 80,
    instruction: "", initialLoc: [4,4], critical : "distractor",}
  var topBlock = {
    url: 'js/stimuli/topBlock.png', name: "topBlock", width: 80, height: 80,
    instruction: "", initialLoc: [1,1], critical : "filler",}
  var binoculars = {
    url: 'js/stimuli/binoculars.png', name: 'binoculars', width: 100, height: 100,
  ...
  var rollOfTape = {
    url: 'js/stimuli/rollOfTape.png', name: "rollOfTape", width: 83, height: 83,
    instruction: "", initialLoc: [1,4], critical : "distractor"}
  var battery = {
    url: 'js/stimuli/battery.png', name: "battery", width: 50, height: 80,
    instruction: "", initialLoc: [1,4], critical : "distractor"}
  var scissors = {
    url: 'js/stimuli/scissors.png', name: "scissors", width: 66, height: 130,
  ...
  var brain = {
    ...
    instruction: "", initialLoc: [3,1],critical : "distractor",};
  var dollar = {
    url: 'js/stimuli/dollar.png', name: 'dollar', width: 130, height: 54,
  ...
  var objectsToShowInContext = [1,2,3,4,5,6,7,8];
  var stimList = _.flatten(_.map(uniqueLabels, function(labelObj) {
    return _.map(referents, function(referent) {
      ...
      if(_.contains(objectsToShowInContext, labelObj.objectSet)) {
