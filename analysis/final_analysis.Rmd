...
ggsave('../../pragmatics_of_perspective_taking_tex/journal_manuscript/figures/hoverOverDistractor.pdf', height = 3, width = 3)
```
...
ggsave("../../pragmatics_of_perspective_taking_tex/journal_manuscript/figures/likelihoodPlot.pdf")
```
