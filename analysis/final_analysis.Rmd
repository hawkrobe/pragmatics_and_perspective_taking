...
ggsave('../../pragmatics_of_perspective_taking_tex/pnas_format/figures/predictives.pdf',
       height = 5, width = 9)
```
...
ggsave('../../pragmatics_of_perspective_taking_tex/pnas_format/figures/predictiveScatter.pdf',
       height = 5, width = 9)
```
...
ggplot(to.plot, aes(x = ego_mean, y = emp_mean)) +
  ...
  xlab('predicted # features')+
  ylab('empirical # features') 
ggsave('../../pragmatics_of_perspective_taking_tex/pnas_format/figures/egocentricScatter.pdf',
       height = 5, width = 9)
```
